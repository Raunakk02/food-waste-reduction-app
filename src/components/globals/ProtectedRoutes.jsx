...
export const RequireAuth = () => {
  const user = useSelector((store) => store.userAuth?.authorization);
  const hasEnteredPin = useSelector((store) => store.global.hasEnteredPin);
...
export const RequireAdminPriviledge = () => {
  const user = useSelector((store) => store.userAuth?.data?.user);
